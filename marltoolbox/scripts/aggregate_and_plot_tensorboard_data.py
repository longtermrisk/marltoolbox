...
PLOT_KEYS = [
    ...
    "norm",
    "buffer_capacity",
    "buffer_num_timesteps_added_wrap",
    "buffer_num_timesteps_added",
]
...
PLOT_ASSEMBLAGE_TAGS = [
    ...
    ("iterations",),
    ("num_steps",),
    ("num_steps_trained_this_iter", "num_agent_steps_trained"),
    (
