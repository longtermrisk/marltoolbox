...
root_path = (
    "/home/alexander/ray_results/cross_play_20K_episodes_binding/2021_03_23/12_37_37"
)
binding = True
...
for match_regime, match_trials in matches.items():
    ...
    for cond_params_i, cond_params in enumerate(cond_params_list):
        eq_list = [
            ...
            if round_cond_params(trial["params"]["cond_params"]) == cond_params
        ]
...
results_filename = os.path.join(
    "cross_play_evals", "results_" + "_".join(root_path.split("/")[-3:]) + ".pickle"
)
...
for agent_0_match_regime, agent_1_match_regime in (
    ...
    for cond_params_i in range(len(cond_params_list)):  # over all types of agents
        ...
        if agent_0_match_regime == agent_1_match_regime:
            ...
            eval_trials_list = [
                (trial_0_i, trial_1_i)
                for trial_0_i in trial_0_indices
                for trial_1_i in trial_1_indices
            ]
