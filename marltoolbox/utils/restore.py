...
def after_init_load_policy_checkpoint(policy, observation_space=None, action_space=None, trainer_config=None):
    """
    Will load a specific policy state from a given checkpoint.
    The config must contain the checkpoint path and policy_id to load.
    This function is to be provided to a policy template as the after_init argument.
    """
