...
class L1BRConfigurationHelper:
    ...
    def define_exp(self, use_n_lvl0_agents_in_each_population: int,
                   train_n_lvl1_agents: int, lvl0_checkpoints: list,
    ...
    def prepare_config_for_lvl1_training(self):
        ...
        checkpoints_per_population, seed_per_population = \
    ...
    def _no_training_no_exploration_for_lvl0_agents(self):
        ...
        self.rllib_config_to_modif["multiagent"]["policies"][
            self.policy_id_for_lvl0_agents][3]["explore"] = False
    ...
    def _convert_checkpoints_idx_list_into_checkpoints_list(
        ...
        checkpoints_per_population = {}
        seed_per_population = []
        for population_n, checkpoints_idx_in_one_population in \
                enumerate(checkpoints_idx_per_population):
