...
#         if done["__all__"]:
#             assert (
#                 abs(info["player_red"]["pick_speed"] - red_speed) < delta_err
#             )
#             assert (
#                 abs(info["player_blue"]["pick_speed"] - blue_speed) < delta_err
#             )
#
#             if red_own is None:
...
#             else:
#                 assert (
#                     abs(info["player_red"]["pick_own_color"] - red_own)
#                     < delta_err
#                 )
#             if blue_own is None:
...
#             else:
#                 assert (
#                     abs(info["player_blue"]["pick_own_color"] - blue_own)
#                     < delta_err
#                 )
#
#             obs = env.reset()
