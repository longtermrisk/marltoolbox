...
def overwrite_pos(env, p_red_pos, p_blue_pos,
                  c_red_pos, c_blue_pos, c_red_coin=True):
...
def assert_info(n_steps, p_red_act, p_blue_act, env, grid_size, max_steps,
                ...
                blue_coop_fraction=None, red_coop_fraction=None,
                red_coop_speed=None, blue_coop_speed=None):
    step_i = 0
    for _ in range(n_steps):
        step_i += 1
        ...
        if done["__all__"]:
            ...
            assert_not_present_in_dict_or_equal("pick_own_color",
                                                red_own, info,
                                                "player_red")
            assert_not_present_in_dict_or_equal("pick_own_color",
                                                blue_own, info,
                                                "player_blue")
            assert_not_present_in_dict_or_equal("blue_coop_fraction",
                                                blue_coop_fraction, info,
                                                "player_blue")
            assert_not_present_in_dict_or_equal("red_coop_fraction",
                                                red_coop_fraction, info,
                                                "player_red")
            assert_not_present_in_dict_or_equal("red_coop_speed",
                                                red_coop_speed, info,
                                                "player_red")
            assert_not_present_in_dict_or_equal("blue_coop_speed",
                                                blue_coop_speed, info,
                                                "player_blue")
...
def test_logged_info_no_picking():
    ...
    for env in envs:
        ...
        assert_info(n_steps, p_red_act, p_blue_act, env, grid_size, max_steps,
                    ...
                    red_coop_speed=0.0, blue_coop_speed=0.0,
                    red_coop_fraction=None, blue_coop_fraction=None)
...
def test_logged_info__blue_pick_blue_all_the_time():
    ...
    for env_i, env in enumerate(envs):
        ...
        assert_info(n_steps, p_red_act, p_blue_act, env, grid_size, max_steps,
                    ...
                    red_coop_speed=0.0, blue_coop_speed=0.0,
                    red_coop_fraction=None, blue_coop_fraction=0.0)
...
def test_logged_info__both_pick_red_all_the_time():
    ...
    for env_i, env in enumerate(envs):
        ...
        assert_info(n_steps, p_red_act, p_blue_act, env, grid_size, max_steps,
                    ...
                    red_coop_speed=1.0, blue_coop_speed=0.0,
                    red_coop_fraction=1.0, blue_coop_fraction=1.0)
...
def test_logged_info__both_pick_blue_half_the_time():
    ...
    for env_i, env in enumerate(envs):
        ...
        assert_info(n_steps, p_red_act, p_blue_act, env, grid_size, max_steps,
                    p_red_pos, p_blue_pos, c_red_pos, c_blue_pos,
                    red_speed=0.0, blue_speed=0.5, red_own=None, blue_own=1.0,
                    red_coop_speed=0.0, blue_coop_speed=0.0,
                    red_coop_fraction=None, blue_coop_fraction=0.0)
...
def test_logged_info__pick_half_the_time_half_blue_half_red():
    ...
    for env_i, env in enumerate(envs):
        ...
        assert_info(n_steps, p_red_act, p_blue_act, env, grid_size, max_steps,
                    p_red_pos, p_blue_pos, c_red_pos, c_blue_pos,
                    red_speed=0.0, blue_speed=0.25, red_own=None, blue_own=1.0,
                    red_coop_speed=0.0, blue_coop_speed=0.0,
                    red_coop_fraction=None, blue_coop_fraction=0.0)
